...
keyboard.keymap = [
    ...
    [
        ...
        KC.TAB,    KC.Q,     KC.W,     KC.E,     KC.R,     KC.T,     KC.Y,     KC.U,     KC.O,    KC.P,    KC.LBRACKET, KC.RBRACKET, KC.BSLASH,
        KC.CLCK,   KC.A,     KC.S,     KC.D,     KC.F,     KC.G,     KC.H,     KC.J,     KC.K,    KC.L,    KC.SCOLON,   KC.QUOTE,    KC.ENTER,
        KC.LSHIFT, KC.Z,     KC.X,     KC.C,     KC.V,     KC.B,     KC.N,     KC.M,     KC.COMM, KC.DOT,  KC.SLSH,     KC.UP,       KC.RSHIFT,
        KC.LCTL,   KC.LGUI,  KC.LALT,  KC.SPC,   KC.SPC,   KC.B,     KC.N,     KC.M,     KC.RALT, KC.PSCR, KC.LEFT,     KC.DOWN,     KC.RIGHT,
    ]
